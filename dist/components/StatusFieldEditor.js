...
export function StatusFieldEditor({ label, options, editable = false, usedValues = [], toneForValue, onOptionsChange, onError, className, ...props }) {
    ...
    return (_jsxs("span", { ref: rootRef, className: joinClassNames('de-status-field-editor', className), ...props, children: [_jsxs("button", { ref: buttonRef, type: "button", className: "de-status-field-trigger", "aria-label": `管理${label}字段值`, "aria-haspopup": "dialog", "aria-expanded": open, "aria-controls": `de-status-field-menu-${instanceId}`, disabled: saving, onClick: () => setOpen((current) => !current), children: [_jsx("span", { children: label }), _jsx("svg", { className: "de-status-chevron", viewBox: "0 0 12 12", "aria-hidden": "true", focusable: "false", children: _jsx("path", { d: "M2.5 4.25 6 7.75l3.5-3.5" }) })] }), mounted && menuStyle
