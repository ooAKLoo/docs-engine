...
export function hasBoardClass(classes, className) {
    return classes.some((value) => value.toLowerCase() === className.toLowerCase());
}
export function resolveNodeBadge(classes) {
...
export function measureBadgeWidth(value) {
 ...
 */
export function measureNode(label, shape, classes = [], authoredWidth) {
    ...
    const contentWidth = Math.max(...lines.map((line, index) => measureDiagramTextWidth(line) * (detailLabel && index > 0 ? 0.86 : 1)), 36);
...
//# sourceMappingURL=BoardNodeMetrics.js.map